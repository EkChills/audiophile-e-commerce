...
const Footer = () => {
  return (
    <div className='bg-semiBlack flex flex-col px-7 py-10 md:px-10 lg:px-[10rem] space-y-12 '>
      <div className='flex flex-col space-y-12 items-center md:items-start lg:space-y-0 lg:flex-row lg:justify-between lg:items-center'>
      ...
      <div className='flex flex-col space-y-12 items-center md:items-start text-center md:text-left'>
        ...
        <div className='flex flex-col space-y-12 items-center md:flex-row w-full md:space-y-0 md:justify-between '>
          <p className='text-[15px] text-darkGray'>Copyright 2021. All Rights Reserved</p>
